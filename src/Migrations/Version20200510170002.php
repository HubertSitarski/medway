 ...
 */
final class Version20200510170002 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD session_id VARCHAR(255) DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP session_id, CHANGE user_id user_id INT DEFAULT NULL');
